...
public class VegaDozeService extends Service {
    private static final String TAG = "VegaDozeService";
    ...
    private VegaProximitySensor mSensor;
    ...
    class VegaProximitySensor implements SensorEventListener {
        ...
        public VegaProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "VegaDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new VegaProximitySensor(mContext);
